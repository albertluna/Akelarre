...
{
    [SerializeField]
    private GameObject delayStartButton; //Boto per entrar en una partida
    [SerializeField]
    ...
    public void DelayStart() //Ligat al boto de quickstart
    {
    ...
    public void DelayCancel() //Lligat al boto de cancelar
    {
